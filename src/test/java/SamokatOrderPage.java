...
public class SamokatOrderPage {
    ...
    private final String name = "Акылбек";
    private final String surname = "Акылбек";
    private final String address = "Астана";
    private final String phoneNumber = "87055463022";
    private final String date = "21.07.2001";
    private final String comment = "Классный самокат";
